...
export default function Skills() {
  const [skills] = useState([
    ...
    { id: 4, name: "Supabase", icon: <SiSupabase size={50} /> },
    { id: 5, name: "Git & GitHub", icon: <div className="flex gap-2"><FaGitAlt size={40} /><BsGithub size={40} /></div> },
  ...
  return (
    <div className="mt-3 lg:mt-16 mb-10 lg:mb-20" id="skills">
            ...
            >
              <div className="flex justify-between flex-col items-start lg:flex-row lg:items-center">
                <div className="flex items-center gap-5">
                  ...
                  <m.h2 className="font-semibold text-white text-lg lg:text-xl">
