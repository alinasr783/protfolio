    ...
    <div className="mt-20" id="home">
      <div className="flex justify-between py-10 items-center px-5 lg:px-28 lg:flex-row flex-col-reverse">
        ...
        >
          ...
          >
            Passionate about technology, I specialize in Web Development and Creative Web Design. I focus on crafting innovative, user-friendly solutions while constantly sharpening my skills. My goal is to grow as a developer and bring meaningful impact to every project I work on
          </motion.p>
